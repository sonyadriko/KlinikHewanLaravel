            ...
            <div class="row justify-content-between align-items-center">
                <div class="col-xl-6 col-lg-6 col-12">
                    <div class="intro-content">
                        ...
                        <div class="intro-btn">
                            <a href="{{ url('login') }}" class="btn btn-primary btn-sm py-2 px-3 me-3 shadow-sm">Mulai</a>
                            <a href="{{ url('about') }}" class="btn btn-outline-dark btn-sm py-2 px-3 shadow-sm">Pelajari
                                Lebih Lanjut</a>
                        </div>
                    </div>
                </div>
                <div class="col-xl-4 col-lg-6 col-12">
                    <div class="mt-4">
                        <img src="{{ asset('assets/images/home.jpg') }}" width="600px"
